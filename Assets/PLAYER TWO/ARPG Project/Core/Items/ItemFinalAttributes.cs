    ...
    public struct ItemFinalAttributes
    {
        ...
        public ItemFinalAttributes(ItemInstance[] items)
        {
            ...
            foreach (var item in items)
            {
                ...
                {
                    fireResistance += item.elements.GetResistance(MagicElement.Fire);
                    waterResistance += item.elements.GetResistance(MagicElement.Water);
                    iceResistance += item.elements.GetResistance(MagicElement.Ice);
                    earthResistance += item.elements.GetResistance(MagicElement.Earth);
                    airResistance += item.elements.GetResistance(MagicElement.Air);
                    lightningResistance += item.elements.GetResistance(MagicElement.Lightning);
                    shadowResistance += item.elements.GetResistance(MagicElement.Shadow);
                    lightResistance += item.elements.GetResistance(MagicElement.Light);
                    arcaneResistance += item.elements.GetResistance(MagicElement.Arcane);
                }
